...
BigInt V3
-----------------------------------------------------------
Oλοκληρωμένo παράδειγμα, αλλά όχι ολοκληρωμένη κλάση
Μην ασχοληθείτε με τις εντολές try, catch, throw
μέχρι να πραγματοποιηθεί η αντίστοιχη θεωρία (exceptions)
===========================================================
*/
